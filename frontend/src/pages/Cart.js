            ...
            <div className='w-full max-w-3xl'>
                {
                    loading ? (
                        loadingCart.map((el,index) => {
                            return(
                                <div key={index} className='w-full bg-slate-200 h-32 my-3 border border-slate-300 animate-pulse rounded'>
                                </div>
                            )
                        })
                        ...
                        data.map((product,index) => {
                            return(
                                <div key={index} className='w-full bg-white h-32 my-3 border border-slate-300 rounded grid grid-cols-[128px,1fr]'>
