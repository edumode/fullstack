...
const ProductDetails = () => {
  ...
  const [zoomImageCoordinate,setZoomImageCoordintate] = useState({
    x : 0,
    y : 0
  })
      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
        ...
        <div className='h-96 flex flex-col lg:flex-row-reverse  gap-4'> 
            ...
            <div className='h-[300px] w-[300px] lg:h-96  lg:w-96 bg-slate-200 p-2' >
              ...
              {
                zoomImage && (
                  <div className='hidden lg:block absolute min-w-[500px] overflow-hidden min-h-[400px] bg-slate-200 p-1 right-[720px] top-20'>
                  ...
                  <div className='flex gap-2 lg:flex-col overflow-scroll scrollbar-none h-full animate-pulse'>
                      {
                        productImageListLoading.map((el,index) => {
                          return(
                            <div className='h-20 w-20 bg-slate-200 rounded p-1' key={"laading"+index}>
          ...
          loading ? (
            <div className='grid gap-1 w-full'>
              ...
              <div className='flex items-center gap-3 my-2 w-full'>
                ...
                <button className='bg-slate-200 rounded animate-pulse h-10 w-full'></button>
              </div>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <div className='flex items-center gap-3 my-2'>
                <button className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px] text-red-600 font-medium hover:bg-red-600 hover:text-white' onClick={(e) => handleByProduct(e,data._id)} >Buy</button>
